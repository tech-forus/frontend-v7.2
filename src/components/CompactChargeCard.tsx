...
//         {isFixed && (
//           <div>
//             <label className="block text-xs font-semibold text-slate-600 mb-1">Fixed Rate</label>
//             <div className="relative">
//               <input
//                 type="number"
//                 value={zeroToBlank(data.fixedAmount ?? null)}
//                 onChange={(e) => onFieldChange('fixedAmount', Number(e.target.value || 0))}
...
//       {/* Variable input + presets (improved UX) */}
//       {isVariable && (
//         <div className="mb-4">
...
//                 className="px-3 py-2 border rounded bg-white text-sm flex items-center gap-2"
//               >
//                 Presets
...
//                   ref={presetsRef}
//                   role="menu"
//                   aria-label="preset percentages"
//                   className="absolute right-0 mt-2 w-36 bg-white border rounded-lg shadow-lg z-30 transition-transform origin-top-right"
...
//             Values will be rounded <strong>up</strong> to nearest 0.1 on blur (e.g. 1.33 → 1.4). Use presets or type manually. Press Escape or click outside to close presets.
//           </p>
//         </div>
//       )}
...
//       {cardName === 'handlingCharges' && (
//         <div>
//           <label className="block text-xs font-semibold text-slate-600 mb-1">Weight Threshold (KG)</label>
//           <div className="relative">
//             <input
//               type="number"
//               value={zeroToBlank(data.weightThreshold ?? null)}
//               onChange={(e) => onFieldChange('weightThreshold', Number(e.target.value || 0))}
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5">
      ...
      <div className="mb-4">
        ...
        {/* Fixed rate UI */}
        {isFixed && (
          <div className={cardName === 'handlingCharges' ? 'pb-5' : ''}>
            <label className="block text-xs font-semibold text-slate-600 mb-1">Fixed Rate</label>
            <div className="relative">
              <input
                type="number"
              ...
              {cardName === 'handlingCharges' && data.unit && (
                <span className="absolute right-3 -bottom-5 px-3 py-1 text-xs font-semibold rounded-full bg-indigo-600 text-white">
                  {data.unit}
                </span>
              )}
            </div>
